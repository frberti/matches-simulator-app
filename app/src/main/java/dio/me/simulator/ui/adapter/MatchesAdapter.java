package dio.me.simulator.ui.adapter;
...
import dio.me.simulator.databinding.MatchItemBinding;
import dio.me.simulator.domain.Match;
import dio.me.simulator.ui.DetailActivity;
...
public class MatchesAdapter extends RecyclerView.Adapter<MatchesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        //Faz o binding dos dados recuperados da api para as views
        ...
        holder.itemView.setOnClickListener(view -> {
            ...
            intent.putExtra(DetailActivity.EXTRA_MATCH, match);
